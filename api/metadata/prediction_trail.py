...
# 시 os.makedirs 로 생성되나 코너 generate 가 enriched 0 → 미기록(graceful). spec §12.
SMALLCAP_PATH = os.path.join(
    os.path.expanduser("~/VERITY_data_lake"), "smallcap_corner_prediction_trail.jsonl"
)
