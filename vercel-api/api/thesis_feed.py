...
_SYSTEM_AVATAR_SVG = """<svg xmlns="http://www.w3.org/2000/svg" viewBox="-185 -205 1240 1240" fill="none"><path d="M74.9999 403.5C74.9999 617 249 754.5 434 754.5C619 754.5 794.5 617 794.5 403.5" stroke="#3A4268" stroke-width="150" stroke-linecap="round"/><path d="M648.655 309.5C648.655 479 561.655 598 433.655 598C309.943 598 216.155 465 220.655 309.5C220.655 143.815 331.655 0 434.655 0C537.655 0 648.655 140 648.655 309.5Z" fill="#6B51EA"/></svg>"""
...
def _public_feed_item(r: dict, profiles: dict, viewer_id: Optional[str], like_counts: dict, liked_ids: set) -> dict:
    ...
    return {
        ...
        "avatar": _SYSTEM_AVATAR if is_system else (prof.get("avatar") or ""),
