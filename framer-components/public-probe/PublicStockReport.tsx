...
const INFO: Record<string, string> = {
    ...
    부채비율:
        "빚 ÷ 자기자본. 높을수록 빚 부담이 크다는 뜻. 업종 중앙값과 함께 봐야 해요.",
    영업이익률:
        "매출 대비 영업이익 비율. 높을수록 본업 수익성이 좋다는 뜻이에요.",
    "Altman-Z":
        "부도 위험 점수. 3 이상이면 안전 구간, 1.8 미만이면 위험 신호로 봐요.",
    ...
    배당수익률:
        "주가 대비 1년 배당금 비율. 높을수록 배당으로 받는 현금이 크다는 뜻이에요.",
    수급: "외국인·기관이 이 종목을 며칠간 순매수(+, 빨강) 했는지 순매도(−, 파랑) 했는지예요. 큰손 자금 방향을 보여주지만, 그 자체가 매수·매도 신호는 아니에요.",
    이동평균:
        "최근 N일 종가의 평균선. 20일=한 달 추세, 60일=분기 추세. 단기선이 장기선 위면 상승 흐름으로 봐요(신호 아님).",
    공시이력:
        "이 종목이 유상증자·전환사채·감자 같은 주주가치 희석·리스크 공시를 언제 몇 번 냈는지의 사실 빈도예요. 반복이 잦을수록 참고하되, 그 자체가 좋다·나쁘다 판단은 아니에요.",
    교차검증:
        "같은 지분율을 DART 공시와 공정거래위원회 공식 자료 두 곳에서 비교한 거예요. 일치하면 신뢰도가 높고, 차이가 나면 기준·시점 차이일 수 있어요.",
    동종업계:
        "같은 섹터 종목들의 중앙값과 이 종목을 비교한 거예요. PER/PBR은 KRX 공식 시총÷DART 재무로 직접 계산했어요. 업종 대비 높은지/낮은지 사실 비교일 뿐, 판단은 아니에요.",
    교차피어:
        "이 종목을 반대 시장(국장↔미장)의 같은 GICS 섹터 종목 중앙값과 비교한 거예요. 어느 MTS도 잘 안 주는 교차시장 비교라 참고하되, 높다·낮다가 좋다·나쁘다 판단은 아니에요.",
    내부자: "임원·주요주주가 자기 회사 주식을 사고(+, 빨강)·팔았는지(−, 파랑)예요. 내부 사정을 아는 사람의 매매라 참고하되, 그 자체가 매수·매도 신호는 아니에요.",
    시장경보:
        "KRX가 공식 지정한 투자주의·투자경고·투자위험·단기과열·관리종목 상태예요. 거래소가 위험을 경고한 사실이라 꼭 확인하되, 자체 판단은 아니에요.",
    "컨센 목표가":
        "증권사들이 제시한 목표주가의 평균이에요. AlphaNest 자체 의견이 아니라 애널리스트 집계 사실이고, 자체 점수는 검증 후(2027) 공개해요.",
    재무제표:
        "DART 전자공시 최근 결산 실값이에요. 손익(번 돈)·재무상태(가진 것/빚)·현금흐름(실제 현금 이동)·비율을 사실 그대로 보여줘요. 단년 기준이라 추이는 아직 없어요.",
    대차잔고:
        "시장에 빌려준 주식 잔고예요(공매도의 재료). 많을수록 공매도 압력이 커질 수 있다는 참고 사실이지, 그 자체가 하락 신호는 아니에요. 진짜 공매도 잔고는 아니에요(KRX 무료 비공개).",
    공매도: "전체 거래 중 공매도가 차지한 비중이에요(최근 5일 평균). 높을수록 하락에 베팅한 거래가 많았다는 뜻으로 참고하되, 그 자체가 매도 신호는 아니에요.",
    신용잔고:
        "빚내서(신용융자) 산 주식의 잔고예요. 많을수록 빚으로 산 물량이 많아, 주가가 내리면 반대매매 부담이 커질 수 있다는 참고 사실이에요.",
...
const GLOSSARY: Record<string, string> = {
    유상증자:
        "새 주식을 발행해 돈을 조달. 주식 수가 늘어 기존 주주 지분이 옅어져요.",
    공급계약: "납품 계약. 매출 대비 규모가 크면 실적 기대 요인이에요.",
    자기주식:
        "회사가 자기 주식을 사거나 보유. 매입하면 시중 주식이 줄어 보통 우호적이에요.",
...
const DEFAULT_LENDING =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/securities_lending.json"
const DEFAULT_SUPPLY =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/supply_demand.json"
...
const KR_INDEX_URL =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/kr_index_daily.json"
const CROSS_KR_URL =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/cross_gics_kr.json" // KR↔US 교차피어: KR 섹터 중앙값
const CROSS_US_URL =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/cross_gics_us.json" // KR↔US 교차피어: US 섹터 중앙값
...
const SAMPLE = [
    {
        ...
        facts_calc: {
            PER: "시가총액 425조 ÷ 순이익 45.2조",
            PBR: "시가총액 425조 ÷ 자기자본 386조",
        },
        header: {
            range_52w: "49,900~88,000",
            trading_value: "4,210억",
            market_cap: "425조",
        },
        overview: {
            tagline: "메모리·파운드리 반도체",
            shares: "5.97억주",
            sector: "반도체",
        },
        warnings: {
            labels: [
                { label: "단기과열", severity: "warn" },
                { label: "투자주의", severity: "caution" },
            ],
        },
        peer: {
            sector: "IT·기술",
        ...
        financials: {
            values: { 매출: "300조", 영업이익: "43조", 순이익: "45조" },
            period: "2025",
            groups: [
                {
                    title: "손익계산서",
        ...
        disclosures: [
            {
                ...
                is_correction: false,
                filer: "삼성전자",
                source_url: DART + "20260615000777",
            },
        ],
        insider: {
            net_change: 95960,
            ...
            trades: [
                {
                    ...
                    source_url: DART + "20260610000111",
                },
                {
                    date: "2026-05-20",
                    person: "한종희",
                    ...
                    change: -20000,
                    shares_after: 50000,
                    source_url: DART + "20260520000222",
                },
            ],
        },
        ownership: {
            ...
            group: "삼성",
            shareholders: [
                { name: "기타", type: "기타", pct: 60.3 },
                { name: "소속회사", type: "소속회사", pct: 19.1 },
                { name: "동일인", type: "동일인", pct: 1.2 },
                { name: "친족", type: "친족", pct: 0.4 },
            ],
            cross_check: {
                entity: "삼성생명",
                dart_pct: 8.51,
    ...
    },
    {
        ...
        market: "KOSDAQ",
        business: "2차전지 양극재",
        facts: { PBR: "4.8", ROE: "8.1%", 부채비율: "184%" },
        facts_note: {},
        financials: {
            values: { 매출: "5조", 영업이익: "2천억" },
            period: "2025",
        },
        disclosures: [],
        ownership: null,
        consensus: { target_price: "165,000원", opinion: "중립" },
        calendar: [],
    },
]
...
const SAMPLE_FORENSICS: Record<string, any> = {
    "005930": {
        ...
        forensics_flags: {
            ...
            dilution_12m: 0,
            dilution_span: "",
            dilution_annual_avg_prior: 0,
            dilution_history_from: "",
        },
        events: [
            {
                date: "2026-06-15",
            ...
            },
            {
                ...
                title: "[기재정정]분기보고서",
                is_correction: true,
                source_url: DART + "20260530000111",
            },
        ],
    },
}
...
function fmtAge(iso: any): string {
    ...
    try {
        const mins = Math.max(
            0,
            Math.round((Date.now() - new Date(String(iso)).getTime()) / 60000)
        )
...
function TrendArrow({
    ...
    return (
        ...
        >
            ...
            {dir === "flat" && (
                <>
                    <line x1="2" y1="6" x2="9.4" y2="6" />
                    <polyline points="6.4,2.8 9.6,6 6.4,9.2" />
                </>
            )}
        </svg>
    )
...
function IndexReportBlock({ C, narrow, name, doc }: any) {
    ...
    const dd = (n: any) => {
        const s = String(n)
        return s.length === 8
            ? s.slice(2, 4) + "." + s.slice(4, 6) + "." + s.slice(6, 8)
            : s
    }
    const head = (
        <div
    ...
    const level = Number(last[1]),
        chg = Number(last[2])
    const periodPct = Number(ser[0][1])
        ? ((level - Number(ser[0][1])) / Number(ser[0][1])) * 100
        : null
    ...
    const CW = 320,
        ...
        PX = 4,
        PY = 8
    const pts = ser.map((s, i) => ({
        x: PX + (i / Math.max(1, ser.length - 1)) * (CW - PX * 2),
        y: PY + (1 - (Number(s[1]) - mn) / rng) * (CH - PY * 2),
    }))
    const linePath = pts
        .map(
            (p, i) =>
        ...
        <div style={{ marginTop: 14 }}>
            ...
            <div style={card}>
                ...
                >
                    ...
                    <span style={{ fontSize: 15, fontWeight: 800, color: upC }}>
                        {chg >= 0 ? "+" : ""}
                        {chg}%
                    </span>
                </div>
                ...
                >
                    금융위 공공데이터 · T+1 EOD(전일 종가) · KRX 지수 사실 ·
                    점수·추천 아님
                </div>
            </div>
        </div>
...
function EtfReportBlock({
    ...
    const fmtF = (won: any, signed = false) => {
        ...
        if (a >= 1e8)
            return sign + Math.round(a / 1e8).toLocaleString() + "억원"
    ...
    for (let i2 = 1; i2 < hist.length; i2++) {
        const prev = hist[i2 - 1],
            cur = hist[i2]
        const dSh = Number(cur.list_shrs) - Number(prev.list_shrs)
        const flow =
            isFinite(dSh) && isFinite(Number(cur.nav))
                ? dSh * Number(cur.nav)
                : 0
        cum += flow
        const prem =
            isFinite(Number(cur.close)) && Number(cur.nav)
                ? ((Number(cur.close) - Number(cur.nav)) / Number(cur.nav)) *
                  100
                : null
    ...
    const prem =
        e && isFinite(Number(e.close)) && Number(e.nav)
            ? ((Number(e.close) - Number(e.nav)) / Number(e.nav)) * 100
            : null
    const CW = 640,
        CH = 110,
        PX = 6,
    ...
    const mn = Math.min(0, ...vals),
        mx = Math.max(0, ...vals),
        rng = mx - mn || 1
    const pts = series.map((s2, i2) => ({
        x: PX + (i2 / Math.max(1, series.length - 1)) * (CW - PX * 2),
        y: PY + (1 - (s2.cum - mn) / rng) * (CH - PY * 2),
    }))
    ...
    return (
        <div style={{ marginTop: 14 }}>
            ...
            >
                ...
                <span
                    style={{ fontSize: 12.5, color: C.faint, fontWeight: 700 }}
                >
                    {ticker}
                </span>
                <span
            ...
            {!e ? (
                <div style={card}>
                    <div style={{ fontSize: 14, fontWeight: 800 }}>
                        이 {market}는 아직 자금흐름 관측 대상이 아니에요
                    </div>
                    <div
                        style={{
                            fontSize: 12.5,
                    ...
                    >
                        흐름 렌즈는 순자산 상위 ETF부터 순차 확대 중이에요.
                        시세·구성종목은 증권사 앱이 정확해요.
                    </div>
                </div>
            ) : isUs ? (
                <>
                ...
                <>
                    <div style={card}>
                        ...
                        >
                            ...
                            >
                                {fmtF(cum || Number(e.est_flow) || 0, true)}
                            </span>
                            <span style={{ fontSize: 12.5, fontWeight: 700 }}>
                                누적 순설정 (최근{" "}
                                {series.length || Number(e.days_n) || 0}거래일)
                            </span>
                        </div>
                        {pts.length >= 2 && (
                            <svg
                        ...
                        {series.length >= 2 && (
                            ...
                            >
                                <span>{ds(series[0].date)}</span>
                                <span>
                                    {ds(series[series.length - 1].date)}
                                </span>
                            </div>
                        )}
                        <div
                    ...
                    <div style={card}>
                        ...
                        >
                            {kv(
                                "종가",
                                Number(e.close).toLocaleString() + "원"
                            )}
                            {kv(
                                "NAV",
                                Math.round(Number(e.nav)).toLocaleString() +
                                    "원"
                            )}
                            {kv(
                                "괴리율",
                        ...
                        >
                            ...
                            {kv(
                                "상장좌수",
                                Number(e.list_shrs).toLocaleString() + "좌"
                            )}
                            {kv(
                                "오늘 순설정",
                                fmtF(e.est_flow, true),
                                Number(e.est_flow) > 0
                                    ? C.up
                                    : Number(e.est_flow) < 0
                                      ? C.down
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <div
                                                    style={{
                                                        width: `${Math.max(3, (Number(h.w) / maxW) * 100)}%`,
                                                        height: "100%",
                                                        borderRadius: 4,
                                                        background: C.vt,
                                                    }}
            ...
            >
                KRX OpenAPI 공시 사실 · 자금흐름 = 설정/환매 관측 · AlphaNest
                의견·추천 아님
            </div>
        </div>
    )
...
function curveLine(p: { x: number; y: number }[]): string {
    ...
    for (let i = 0; i < p.length - 1; i++) {
        ...
        const p2 = p[i + 1]
        const p3 = p[i + 2] || p2
        const c1x = p1.x + (p2.x - p0.x) * CURVE_TENS,
            c1y = p1.y + (p2.y - p0.y) * CURVE_TENS
        const c2x = p2.x - (p3.x - p1.x) * CURVE_TENS,
            c2y = p2.y - (p3.y - p1.y) * CURVE_TENS
...
function FinTrend({
    ...
    const valOf = (p: any) =>
        p && p[metric] != null && !isNaN(Number(p[metric]))
            ? Number(p[metric])
            : null
    ...
    const areaPath =
        defined.length >= 2
            ? linePath +
              ` L ${defined[defined.length - 1].x} ${baseY} L ${defined[0].x} ${baseY} Z`
            : ""
    // 마진율 % 오버레이 (영업이익률/순이익률) — 매출 선택 시 생략. 자체 y-범위(추이 모양용).
    const revOf = (p: any) =>
        p && p.revenue != null && !isNaN(Number(p.revenue))
            ? Number(p.revenue)
            : null
    const showMargin = metric !== "revenue"
    const marginVals = pts.map((p) => {
        const v = valOf(p)
        const r = revOf(p)
        return v != null && r && r !== 0 ? (v / r) * 100 : null
    })
        ...
        >
                ...
                {METRICS.map((m) => (
                    <button
                        ...
                        style={{
                            ...
                            fontWeight: 800,
                            fontFamily: FONT,
                            background: metric === m.k ? C.vt : C.bg,
                            color: metric === m.k ? C.onAccent : C.sub,
                        }}
                    >
                        {m.l}
                    </button>
            ...
            >
                ...
                {showMargin && lastMargin != null && (
                    ...
                    >
                        {marginLabel} {lastMargin.toFixed(1)}%
                    </span>
                )}
            </div>
            {/* 과거 비교 칩 */}
                ...
                {pts.map((p, i) => (
                    <div
                        ...
                        style={{
                            ...
                            fontSize: 8.5,
                            fontWeight: 700,
                            color: Number(p.year) === lastYear ? C.vt : C.faint,
                        }}
                    >
                        {i === 0 ||
                        i === pts.length - 1 ||
            ...
            >
                {usd ? "SEC 10-K" : "DART 전자공시"} 연간 실값(추이선) · 증감은
                위 과거 비교 칩(↑증가 ↓감소)
            </div>
        </div>
    )
...
const QT_DEFAULT_URL =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/dart_quarterly_public.json"
const QT_US_URL =
    "https://rte5guenhonw9fzn.public.blob.vercel-storage.com/us_quarterly_public.json" // 미장 분기추이(us_quarterly_public_builder)
const QT_METRICS: {
    key: string
    label: string
    unit: string
    ...
    for (let y = 2021; y <= 2025; y++)
        for (const e of ends) {
            ...
            qs.push({
                ...
                current_ratio: +(98 + 67 * t + Math.sin(i * 0.8) * 5).toFixed(
                    1
                ),
...
function QuarterlyTrend({
    ...
    useEffect(() => {
        ...
        fetch(quarterlyUrl)
            ...
            .then((d) => {
                ...
                const arr =
                    rec && Array.isArray(rec.quarters) ? rec.quarters : null
    ...
    useEffect(() => {
        if (onCount) onCount(series.length)
    }, [series.length])
    ...
    const CH = 84,
        PX = 4,
        PY = 20 // PY 크게 = 최고/최저 라벨이 라인·상하단과 안 겹침
    return (
        <div
            ref={ref}
            style={{
                background: C.card,
                borderRadius: 16,
                padding: narrow ? "15px 14px" : "17px 18px",
                boxShadow: "0 1px 3px rgba(0,0,0,0.04)",
            }}
        >
            <div
            ...
            >
                ...
                <span style={{ fontSize: 11, color: C.faint, fontWeight: 600 }}>
                    {embedded
                        ? `최근 ${series.length}분기 · 실값`
                        : `최근 ${series.length}분기 · DART 분기보고서 · 사실`}
                </span>
            </div>
            <div
                style={{
            ...
            >
                {QT_METRICS.map((m, mi) => {
                    ...
                    const arrowDir: "up" | "down" | "flat" = flat
                        ? "flat"
                        : improved
                          ? "up"
                          : "down"
                    ...
                    const n = raw.length
                    const xAt = (i: number) =>
                        PX + (n <= 1 ? 0 : (i / (n - 1)) * (CW - PX * 2))
                    const yAt = (v: number) =>
                        PY + (1 - (v - lo) / span) * (CH - PY * 2)
                    const pts = raw
                        .map((v, i) =>
                            v == null ? null : { x: xAt(i), y: yAt(v), v, i }
                        )
                        .filter(
                            (
                                p
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    {qtLabel(series[series.length - 1].q)}
                                </span>
                            </div>
                        </div>
                    )
            ...
            >
                출처 DART 분기·반기·사업보고서 · 비율 자체계산(사실)
                {showExtremes ? " · ○ 최고·최저점" : ""}
                {onCanvas && (
                    <span style={{ color: C.amber }}>
                        {" "}
                        · ⚠ SAMPLE 미리보기(실데이터는 backfill 누적 후)
                    </span>
                )}
            </div>
        </div>
    ...
    return (
        <>
            ...
            >
                ...
                <div style={{ flex: 1 }}>
                    <div style={sk(140, 18, 6)} />
                    <div style={sk(90, 13, 5, 8)} />
                </div>
                <div>
                    <div style={sk(100, 22, 6)} />
                    <div style={sk(64, 13, 5, 8)} />
                </div>
            </div>
            <div style={{ ...card, display: "flex", gap: 8 }}>
                {[0, 1, 2, 3].map((i) => (
                    <div key={i} style={{ flex: 1 }}>
                        <div style={sk("100%", 48, 10)} />
                    </div>
                ))}
            </div>
            <div style={card}>
                <div style={sk("100%", narrow ? 200 : 240, 12)} />
            </div>
            {[0, 1].map((i) => (
...
function parseKRWCompact(v: any): number | null {
    ...
    const unit = m[2]
    const mul =
        unit === "조" ? 1e12 : unit === "억" ? 1e8 : unit === "만" ? 1e4 : 1
...
function FlowDivergingChart({
    ...
    useEffect(() => {
        ...
        if (!el || typeof ResizeObserver === "undefined") return
        const ro = new ResizeObserver((es) => {
            for (const e of es) setBw(e.contentRect.width)
        })
        ro.observe(el)
        return () => ro.disconnect()
    }, [])
    const data = (rows || []).filter(
        (r) => r && (r.foreign_net != null || r.inst_net != null)
    )
    const maxAbs = Math.max(
        1,
        ...data.map((r) =>
            Math.max(
                Math.abs(Number(r.foreign_net) || 0),
                Math.abs(Number(r.inst_net) || 0)
            )
        )
    )
    const H = 132,
        MID = H / 2,
        AMP = MID - 16 // 상하 여백 = 직접 라벨 자리
    ...
    return (
        <div
            ref={boxRef}
            style={{ position: "relative", padding: "4px 2px 0" }}
        >
                    ...
                    >
                        <span
                            style={{
                                ...
                                borderRadius: 3,
                                background:
                                    s2.key === "foreign_net" ? C.ink : C.faint,
                            }}
                        />
                        {s2.label}
                    </span>
            ...
            {hov &&
                (() => {
                    ...
                    return (
                        ...
                        >
                            <b>{dateDot(r.date)}</b> · {lbl}{" "}
                            <span
                                style={{
                                    fontWeight: 800,
                                    color: v >= 0 ? "#ff8f97" : "#9fc6ff",
                                }}
                            >
                                {fmtSharesExact(v)}
                            </span>
...
function CashflowWaterfall({
    ...
    const pick = (k: string) => {
        const r = rows.find((x: any) => String(x.k || "").indexOf(k) === 0)
        return r ? parseKRWCompact(r.v) : null
    }
    const op = pick("영업활동"),
        inv = pick("투자활동"),
        fin = pick("재무활동")
    ...
    let run = 0
    const bars = steps.map((s2) => {
        const from = run
        run += s2.v
        return { ...s2, from, to: run }
    })
    ...
    const cells = [
        ...bars.map((b, i) => ({
            ...
            i,
            isTotal: false,
            top: Math.min(yAt(b.from), yAt(b.to)),
            bot: Math.max(yAt(b.from), yAt(b.to)),
        })),
        {
            label: "순증감",
            v: net,
            ...
            i: bars.length,
            isTotal: true,
            top: Math.min(zeroY, yAt(net)),
            bot: Math.max(zeroY, yAt(net)),
        },
    ]
    return (
        <div ref={boxRef} style={{ position: "relative" }}>
            ...
            >
                DART 현금흐름표 실값을 순서대로 누적 · 순증감 = 영업+투자+재무
                (더하기만, 자체 산식 0) · 점수·추천 아님
            </div>
        </div>
    )
}
...
export default function PublicStockReport(props: Props) {
    ...
    const [flowMap, setFlowMap] = useState<Record<string, any[]>>(
        onCanvas ? SAMPLE_FLOW : {}
    )
    const [forensicsMap, setForensicsMap] = useState<Record<string, any>>(
        onCanvas ? SAMPLE_FORENSICS : {}
    )
    const [insiderMap, setInsiderMap] = useState<Record<string, any>>(
        onCanvas ? SAMPLE_INSIDER : {}
    )
    const [warnMap, setWarnMap] = useState<Record<string, any>>(
        onCanvas ? SAMPLE_WARN : {}
    )
    ...
    useEffect(() => {
        ...
        fetch(
            ...
            .then((d) => {
                ...
                try {
                    window.localStorage.setItem("verity_last_ticker", tk)
                } catch (e) {}
                try {
    ...
    const kind = useMemo(() => {
        const u = searchList.find(
            (x: any) => String(x.ticker) === String(selTicker)
        )
    ...
    useEffect(() => {
        if (onCanvas || typeof document === "undefined" || !document.body)
            return
    ...
    useEffect(() => {
        ...
        const url =
            kind === "index"
                ...
                : isUsEtf
                  ? US_ETF_URL
                  : ETF_FLOW_URL // 지수 / US·KR ETF
        fetch(url)
            .then((r) => (r.ok ? r.json() : null))
            .then((d) => {
                if (alive && d) setEtfDoc(d)
            })
            .catch(() => {})
        return () => {
            alive = false
    ...
    useEffect(() => {
        if (onCanvas) return
        if (kind === "etf" || kind === "index") {
            setListLoaded(true)
            return
        }
        const t = String(selTicker || "")
            .trim()
            .toUpperCase()
        if (!t) return
        let alive = true
        fetch(base + "/api/stock_slice?ticker=" + encodeURIComponent(t))
            ...
            .then((d) => {
                ...
                const merge = (setter: any, sec: any) =>
                    setter((prev: any) => ({
                        ...prev,
                        [t]: sec != null ? sec : null,
                    }))
        ...
        const hit =
            ...
            searchList.find(
                (x: any) =>
                    String(x.name || "")
                        .toLowerCase()
                        .includes(low) || String(x.name_ko || "").includes(t)
            )
    ...
    useEffect(() => {
        ...
        fetch(UNIVERSE_URL)
            ...
            .then((d) => {
                ...
                if (alive && Array.isArray(a) && a.length) setSearchList(a)
            })
            .catch(() => {})
        return () => {
            alive = false
    ...
    useEffect(() => {
        ...
        let alive = true
        fetch(
            base + "/api/verity/us-forensics?ticker=" + encodeURIComponent(t),
            { cache: "no-store" }
        )
            .then((r) => (r.ok ? r.json() : null))
            .then((d) => {
                if (alive)
                    setUsForen(
                        d && d.status === "ok" ? d.sections || null : null
                    )
            })
            .catch(() => {})
        return () => {
    ...
    const s = useMemo(() => {
        ...
        if (
            lastGoodRef.current &&
            String(lastGoodRef.current.ticker) === String(selTicker)
        )
            return lastGoodRef.current
        const u2 = searchList.find(
            (x) => String(x.ticker) === String(selTicker)
        )
        if (u2)
            return {
    ...
    const sliceReady =
        list.some((x: any) => String(x.ticker) === String(selTicker)) ||
        String(noReportTk) === String(selTicker)
    ...
    useEffect(() => {
        if (onCanvas || !watchToken || !s.ticker) {
            setStarItemId(null)
            return
        }
        let alive = true
        fetch(base + "/api/watchgroups", {
            ...
            .then((groups) => {
                ...
                if (groups.length && groups[0] && groups[0].id)
                    setWatchGroupId(String(groups[0].id))
                let found: any = null
                for (const g of groups) {
                    for (const it of g.items || []) {
                        if (
                            String(it.ticker || "").trim() === String(s.ticker)
                        ) {
                            found = it
                            break
                        }
    ...
    const goTicker = (tk: any, nm?: any) => {
        ...
        try {
            ...
            const name =
                nm ||
                (list.find((x: any) => String(x.ticker) === t) || {}).name ||
                t
    ...
    const lendingRow = useMemo(
        () => (lendingMap && lendingMap[s.ticker]) || null,
        [lendingMap, s.ticker]
    )
    const supplyRow = useMemo(
        () => (supplyMap && supplyMap[s.ticker]) || null,
        [supplyMap, s.ticker]
    )
    ...
    const foren = useMemo(
        ...
        [forensicsMap, s.ticker]
    )
    const insider = useMemo(
        () => (insiderMap && insiderMap[s.ticker]) || null,
        [insiderMap, s.ticker]
    )
    const warn = useMemo(
        () => (warnMap && warnMap[s.ticker]) || null,
        [warnMap, s.ticker]
    )
    const warnLabels = warn && Array.isArray(warn.labels) ? warn.labels : []
    const warnTop = warnLabels.some((l: any) => l.severity === "danger")
        ? "danger"
        : warnLabels.some((l: any) => l.severity === "warn")
          ? "warn"
          : warnLabels.length
            ? "caution"
            : null
    ...
    const synth = useMemo(() => {
        ...
        if (facts["Altman-Z"])
            f.push(
                "Altman-Z " +
                    facts["Altman-Z"] +
                    (fnote["Altman-Z"] ? "(" + fnote["Altman-Z"] + ")" : "")
            )
        if (financials && financials.values && financials.values["매출"])
            f.push("매출 " + financials.values["매출"])
        if (disclosures.length) f.push("최근 공시 " + disclosures.length + "건")
        if (insider && insider.total)
            f.push("내부자 거래 " + insider.total + "건")
        if (ownership && ownership.family_pct != null)
            f.push("총수일가 " + ownership.family_pct + "%")
        return f
    }, [
        s,
        facts,
    ...
    const renderTitle = (text: string, idKey: string) => {
        ...
        while (rest.length && guard < 40) {
            ...
            const hov = hoverCapable
                ? {
                      onMouseEnter: (e: any) => openTipAt(e, tipId),
                      onMouseLeave: () => setOpenTip(""),
                  }
                : {}
            parts.push(
                ...
                >
                    <span
                        ...
                        onClick={(e) => {
                            e.stopPropagation()
                            if (isOpen) setOpenTip("")
                            else openTipAt(e, tipId)
                        }}
                        {...hov}
                        style={{
                            borderBottom: `1px dashed ${C.vt}`,
                            cursor: "help",
                        }}
                    >
                        {hitKey}
    ...
    const tipKV = (label: string, value: any, color?: string) => (
        ...
        >
            ...
            <span
                style={{ fontSize: 12, color: color || C.ink, fontWeight: 800 }}
            >
                {value}
            </span>
        </div>
    ...
    const catColor = (cat: string) =>
        DILUTION_CATS.has(cat)
            ? C.amber
            : RISK_CATS.has(cat)
              ? C.up
              : FAVORABLE_CATS.has(cat)
                ? C.green
                : cat === "정정공시"
                  ? C.faint
                  : C.sub
    const shTypeColor = (t: string) =>
        t === "동일인" || t === "친족"
            ? C.vt
            : t === "소속회사"
              ? C.down
              : t === "자기주식" || t === "기타"
                ? C.faint
                : C.sub
    const finValColor = (v: any) =>
        typeof v === "string" && v.trim().charAt(0) === "−" ? C.down : C.ink

    // 토스풍 경보 — 심각도별 부드러운 틴트 배경만(외곽선 없음). 경보 시 헤더 통째 감쌈.
    const warnTint =
        warnTop === "danger" ? C.upS : warnTop === "warn" ? C.amberS : C.card
    const warnAccent =
        warnTop === "danger" ? C.up : warnTop === "warn" ? C.amber : C.sub
    const headerBox: CSSProperties = warnTop
        ? {
              marginTop: 14,
              background: warnTint,
              borderRadius: 18,
              padding: narrow ? "13px 14px" : "15px 17px",
          }
    ...
    const searchBox = (
        <div style={{ position: "relative" }}>
            ...
            <input
                style={inputStyle}
                placeholder={`종목 검색 (이름·코드) · 전 종목 ${searchList.length}개`}
                value={query}
                    ...
                    {query.trim() ? (
                        matches.map((m) => (
                            ...
                            <div
                                key={m.ticker}
                                onMouseDown={() =>
                                    goTicker(m.ticker, m.name_ko || m.name)
                                }
                                style={{
                                    display: "flex",
                                    alignItems: "center",
        ...
        return (
            <div ref={rootRef} style={wrap}>
                ...
                <IndexReportBlock
                    C={C}
                    narrow={narrow}
                    name={String(uEntI.name || selTicker)}
                    doc={etfDoc}
                />
            </div>
        )
    ...
    return (
        <div ref={rootRef} style={wrap}>
            ...
            {s._noReport && !onCanvas && (
                ...
                >
                    아직 정밀 리포트가 준비되지 않은 종목이에요. 시세·차트는
                    실시간 차트 위젯과 네이버에서 볼 수 있어요 — 리포트는 순차
                    확대 중이에요.
                </div>
            )}
            ...
            <div style={headerBox}>
                ...
                >
                    ...
                    {warnTop &&
                        warnLabels.map((l: any, i: number) => (
                            <span
                                key={i}
                                style={{
                                    fontSize: 11,
                                    fontWeight: 800,
                                    color: sevC(l.severity).fg,
                                    background: C.card,
                                    borderRadius: 999,
                                    padding: "3px 10px",
                                }}
                ...
                {!onCanvas && naverStockUrl(String(s.ticker || "")) && (
                    <div style={{ marginTop: 7 }}>
                        <a
                            href={naverStockUrl(String(s.ticker || ""))}
                            target="_blank"
                ...
                {warnTop && (
                    ...
                    >
                        KRX 공식 지정 시장경보 — 자체 판단 아님. 투자 전 거래소
                        경고 꼭 확인
                    </div>
                )}
            </div>
            ...
            {synth.length > 1 && (
                ...
                >
                    ...
                    >
                        화면의 사실을 규칙으로 추린 요약 — AI 작문·자체 등급
                        아님
                    </div>
                </div>
            )}
            ...
            {(() => {
                ...
                if (per)
                    cards.push({
                        q: "지금 싸 보이나?",
                        a: "PER " + per.value,
                        sub: "섹터 중앙값 " + per.median + arr(per.vs),
                    })
                const roe = rowOf("ROE")
                if (roe)
                    cards.push({
                ...
                if (insider && insider.trades && insider.trades.length) {
                    ...
                    const recent = insider.trades.filter(
                        (t: any) => parseD(t.date) >= cutoff
                    )
                    const buyers = new Set(
                        recent
                            .filter((t: any) => Number(t.change) > 0)
                            .map((t: any) => t.person)
                    )
                ...
                if (debt || disclosures.length)
                    cards.push({
                        q: "망가질 유의사항?",
                        a: debt
                            ? "부채비율 " + debt.value
                            : "최근 공시 " + disclosures.length + "건",
                        sub: disclosures.length
                            ? "최근 공시 " + disclosures.length + "건"
                            : debt
                              ? "섹터 " + debt.median + arr(debt.vs)
                              : "",
                    })
                    ...
                    >
                        ...
                        >
                            ...
                            <div>
                                ...
                                >
                                    {fmtVol(lendingRow.redemption_qty)}
                                </div>
                            </div>
                        </div>
                        <div
                        ...
                        >
                            대차잔고 = 시장에 빌려준 주식(공매도 재료·압력
                            proxy). 진짜 공매도 잔고 아님 · 외부 사실
                            {lendAsOf ? " · " + dateDot(lendAsOf) : ""}
                        </div>
                    </div>
                </>
            )}
            ...
            {Object.keys(facts).length > 0 && (
                <>
                    ...
                    <div
                        style={{
                            display: "grid",
                            gridTemplateColumns: `repeat(auto-fit, minmax(${narrow ? 100 : 120}px, 1fr))`,
                            gap: 10,
                        }}
                    >
            ...
            {/* 기업 개요 */}
            {overview &&
                (overview.sector || overview.shares || overview.tagline) && (
                    <>
                        ...
                        >
                            {[
                                ["사업", overview.tagline],
                                ["업종", overview.sector],
                                ["발행주식수", overview.shares],
                            ]
                                .filter((x) => x[1])
                                .map(([k, v]: any, i) => kvRow(k, v, i))}
                        </div>
                    </>
                )}
            ...
            {(() => {
                ...
                const rows = KEYS.map((k: string) => {
                    ...
                    return {
                        ...
                        own: pr.value,
                        med: med + suf,
                        vs: own > med ? "above" : own < med ? "below" : "equal",
                        n: (om.ns && om.ns[k]) || 0,
                    }
                ...
                return (
                    <>
                        ...
                        >
                            ...
                            >
                                {otherLabel} 상장사 중 같은 GICS 섹터(
                                <b style={{ color: C.sub }}>{secKo}</b>) 종목의
                                중앙값과 비교 · 어느 MTS도 안 주는 교차시장 사실
                                — 높다·낮다가 좋다·나쁘다는 아님(RULE 7).
                                섹터=yfinance GICS(미상장분 SIC 근사).
                            </div>
                        </div>
                    </>
                )
                    ...
                    <>
                        {show &&
                            sectionTitle(
                                ...
                                tab === "annual"
                                    ? (isKRt ? "DART" : "SEC 10-K") +
                                          " · 연간 손익 실값 · 과거(1·3·5년) 비교"
                                    : (isKRt ? "DART 분기보고서" : "SEC 10-Q") +
                                          " · 건전성 비율(부채·ROA·유동·마진)"
                            )}
                        {both && (
                            <div
            ...
            {financials &&
                financials.values &&
                Object.keys(financials.values).length > 0 && (
                    <>
                        {sectionTitle(
                            "재무 요약",
                            "DART · " +
                                (financials.period || "최근 결산") +
                                (finGroups.length ? " · 탭=재무제표 전체" : ""),
                            finGroups.length ? "재무제표" : undefined
                        )}
                        <div
                            style={{
                                background: C.card,
                        ...
                        >
                            {Object.keys(financials.values).map((k, i) =>
                                kvRow(k, financials.values[k], i)
                            )}
                            {finGroups.length > 0 && (
                                <>
                                    <button
                                        ...
                                        style={{
                                            ...
                                            fontWeight: 800,
                                            fontFamily: FONT,
                                            background: openFin ? C.vg : C.bg,
                                            color: openFin ? C.onAccent : C.sub,
                                        }}
                                    >
                                        {openFin
                                            ? "재무제표 접기"
                                            : "재무제표 전체 보기 (손익·재무상태·현금흐름·비율)"}
                                    </button>
                                    {openFin && (
                                        <div
                                            style={{
            ...
            {(() => {
                const cf = finGroups.find(
                    (g: any) =>
                        String((g && g.title) || "").indexOf("현금흐름") >= 0
                )
                if (!cf) return null
            ...
            {foren && foren.events && foren.events.length > 0 && (
                <>
                    ...
                    >
                        ...
                        >
                            {Object.keys(foren.counts || {})
                                .sort(
                                    (a, b) => foren.counts[b] - foren.counts[a]
                                )
                                .map((cat) => (
                                    <span
                                        key={cat}
                                    ...
                                    >
                                        {cat} {foren.counts[cat]}회
                                    </span>
                                ))}
                        </div>
                        {foren.dilution_count > 0 && (
                            <div
                                style={{
                                    fontSize: 12,
                                    color: C.amber,
                            ...
                            >
                                희석성 공시(유상증자·CB·BW 등) 합{" "}
                                {foren.dilution_count}회 — 사실 빈도일 뿐, 위험
                                판단 아님
                            </div>
                        )}
                        {foren.forensics_flags &&
                            (foren.forensics_flags.dilution_12m > 0 ||
                                ...
                                >
                                    {foren.forensics_flags.dilution_12m > 0 && (
                                        ...
                                        >
                                            최근 12개월 희석{" "}
                                            {foren.forensics_flags.dilution_12m}
                                            회
                                            {foren.forensics_flags
                                                .dilution_annual_avg_prior > 0
                                                ? ` (직전 연평균 ${foren.forensics_flags.dilution_annual_avg_prior}회)`
                                                : ""}
                                            {foren.forensics_flags.dilution_span
                                                ? ` · ${foren.forensics_flags.dilution_span}`
                                                : ""}
                                        </span>
                                    )}
                                    {foren.forensics_flags.correction_count >
                                        0 && (
                                        <span
                                            style={{
                                                fontSize: 11.5,
                        ...
                        {foren.events.length > 6 && (
                            <button
                                onClick={() => setForenAll((v) => !v)}
                                style={{
                                    width: "100%",
                                    marginTop: 8,
                                    border: "none",
                            ...
                            >
                                {forenAll
                                    ? "접기"
                                    : `이력 ${foren.events.length}건 전체 보기`}
                            </button>
                        )}
                        <div
                            style={{
                        ...
                        >
                            DART 원문 제목 기준 이벤트 빈도(사실) · 현재 수집창
                            한정(과거 백필 시 심화)
                        </div>
                    </div>
                </>
                ...
                <>
                    ...
                    >
                        ...
                        >
                            ...
                            <span
                                style={{
                                    ...
                                    fontWeight: 800,
                                    color:
                                        (insider.net_change || 0) >= 0
                                            ? C.up
                                            : C.down,
                                }}
                            >
                                순증감 {fmtShares(insider.net_change)}
                            </span>
                        </div>
                        ...
                        {(() => {
                            ...
                            const recent = tr.filter(
                                (t) => parseD(t.date) >= cutoff
                            )
                            const buyers = new Set(
                                recent
                                    .filter((t) => Number(t.change) > 0)
                                    .map((t) => t.person)
                            )
                            const sellers = new Set(
                                recent
                        ...
                        {insider.trades.length > 6 && (
                            <button
                                onClick={() => setInsiderAll((v) => !v)}
                                style={{
                                    width: "100%",
                                    marginTop: 8,
                                    border: "none",
                            ...
                            >
                                {insiderAll
                                    ? "접기"
                                    : `거래 ${insider.trades.length}건 전체 보기`}
                            </button>
                        )}
                        <div
                            style={{
                        ...
                        >
                            DART 공시 사실(보고자·증감 +매수/−매도)만 · 자체
                            매매신호 아님 · 토스·네이버엔 없는 내부자 view
                        </div>
                    </div>
                </>
            )}
            ...
            {usForen && (
                <>
                    {usForen.insider &&
                        usForen.insider.trades &&
                        usForen.insider.trades.length > 0 && (
                            <>
                                {sectionTitle(
                                    "美 내부자 거래 · SEC Form 4",
                                    "임원·이사·10%주주"
                                ...
                                >
                                    ...
                                    >
                                        SEC Form 4 공시 사실(취득+/처분−)만 ·
                                        자체 매매신호 아님 · 증권사·토스엔 없는
                                        view
                                    </div>
                                </div>
                            </>
                    ...
                    {usForen.holdings &&
                        usForen.holdings.filings &&
                        usForen.holdings.filings.length > 0 && (
                            <>
                                {sectionTitle(
                                    "美 대량보유 · SEC 13D/13G",
                                    "5%+ 신고"
                    ...
                    {usForen.smart_money &&
                        usForen.smart_money.holders &&
                        usForen.smart_money.holders.length > 0 && (
                            <>
                                {sectionTitle(
                                    "美 스마트머니 · 13F",
                                    "집중형 액티브 펀드"
                                ...
                                >
                                    ...
                                    >
                                        보유 펀드{" "}
                                        {usForen.smart_money.holder_count ||
                                            usForen.smart_money.holders.length}
                                        곳{" "}
                                        <span
                                            style={{
                                                color: C.faint,
                    ...
                    {usForen.disclosure_forensics &&
                        usForen.disclosure_forensics.counts &&
                        Object.keys(usForen.disclosure_forensics.counts)
                            .length > 0 &&
                        (() => {
                            const FLBL: any = {
                                dilution: "희석성 증자(3.02)",
                                delisting_risk: "상장폐지 위험(3.01)",
                                bankruptcy: "파산(1.03)",
                                debt_default: "채무불이행(2.04)",
                                impairment: "자산손상(2.06)",
                                restatement: "재무제표 정정(4.02)",
                                auditor_change: "감사인 교체(4.01)",
                                mna: "인수·합병(2.01)",
                                rights_modification: "주주권리 변경(3.03)",
                                control_change: "지배권 변경(5.01)",
                                restructuring: "구조조정(2.05)",
                            }
                            const df = usForen.disclosure_forensics
                            const adverse = (k: string) =>
                                /delisting_risk|bankruptcy|debt_default|restatement|impairment/.test(
                                    k
                                )
                            return (
                                <>
                    ...
                    {usForen.short_interest &&
                        usForen.short_interest.short_pct != null && (
                            <>
                                {sectionTitle(
                                    "美 공매도 잔고 · Short Interest",
                                    "yfinance · 월 2회 공시"
                                )}
                                <div
                                    style={{
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            {usForen.short_interest.short_pct}%
                                        </span>
                                        <span
                                            style={{
                                                fontSize: 12,
                                    ...
                                    >
                                        {usForen.short_interest.days_to_cover !=
                                        null ? (
                                            <span>
                                                숏커버{" "}
                                                {
                                        ...
                                        {usForen.short_interest.shares_short !=
                                        null ? (
                                            <span>
                                                공매도{" "}
                                                {fmtShares(
                                        ...
                                        {usForen.short_interest.report_date ? (
                                            <span style={{ color: C.faint }}>
                                                {
                                                    usForen.short_interest
                                                        .report_date
                ...
                <>
                    ...
                    >
                        {(/^[0-9]{6}$/.test(String(s.ticker))
                            ...
                            : [
                                  {
                                      label: "StockAnalysis · 목표가·의견",
                                      url: `https://stockanalysis.com/stocks/${String(s.ticker).toLowerCase()}/forecast/`,
                                  },
                                  {
                                      label: "Yahoo Finance",
                ...
                <>
                    ...
                    >
                        ...
                        >
                            <span
                                style={{
                                    width: Number(ownership.family_pct) + "%",
                                    background: C.vt,
                                }}
                            />
                            <span
                                style={{
                                    width:
                                        100 -
                                        Number(ownership.family_pct) +
                                        "%",
                                    background: C.line,
                                }}
                            />
                        </div>
                        {Array.isArray(ownership.shareholders) &&
                            ownership.shareholders.length > 0 && (
                                <div style={{ marginTop: 10 }}>
                                    {ownership.shareholders.map(
                                        (sh: any, i: number) => {
                                            const nm =
                                                sh.name && sh.name !== sh.type
                                                    ? String(sh.name)
                                                    : ""
                                            const generic =
                                                !nm ||
                                                /기타|소액주주|자기주식|우리사주|^친족$|^동일인$|^임원$|기관투자|외국인|개인투자자|국민연금공단/.test(
                                                    nm
                                                )
                                            const corp =
                                                sh.type === "소속회사" ||
                                                /(주식회사|\(주\)|㈜|회사|Ltd|LTD|Inc|INC|Limited|Corp|Company|생명|화재|증권|물산|홀딩스|투자|캐피탈|은행|보험|자산운용|전자|중공업|텔레콤|공단|재단)/.test(
                                                    nm
                                                )
                        ...
                        {ownership.cross_check &&
                            ownership.cross_check.status && (
                                <div
                                    style={{
                                        marginTop: 12,
                                        background: C.vtS,
                                ...
                                >
                                    ...
                                    >
                                        {ownership.cross_check.entity && (
                                            <b>
                                                {ownership.cross_check.entity}
                                            </b>
                                        )}
                                        {ownership.cross_check.dart_pct !=
                                            null && (
                                            <>
                                                {" "}
                                                · DART{" "}
                        ...
                        {(ownership.parent || ownership.sub_count != null) && (
                            ...
                            >
                                {ownership.parent && (
                                    <span>모회사 · {ownership.parent}</span>
                                )}
                                {ownership.sub_count != null && (
                                    <span>
                                        계열사 · {ownership.sub_count}개
                                    </span>
                                )}
                            </div>
                        )}
                        {Array.isArray(ownership.subsidiaries) &&
                            ownership.subsidiaries.length > 0 && (
                                <div style={{ marginTop: 14 }}>
                                    <div
                                        style={{
                                            fontSize: 12,
                        ...
                        {ownership.source && (
                            ...
                            >
                                {ownership.source} · 1차 출처(나무위키 아님)
                            </div>
                        )}
                    </div>
                </>
            ...
            {empRow &&
                ...
                (() => {
                    const ymTxt =
                        empRow.ym && String(empRow.ym).length === 6
                            ? String(empRow.ym).slice(2, 4) +
                              "." +
                              Number(String(empRow.ym).slice(4)) +
                              "월"
                            : ""
                    const net = Number(empRow.net) || 0
                    const netColor =
                        net > 0 ? C.green : net < 0 ? C.down : C.faint
                    ...
                    return (
                        <>
                            ...
                            >
                                ...
                                >
                                    국민연금공단 가입 사업장 공시 · 사업장명
                                    정확일치 매칭 (고용 프록시 — 가입 제외
                                    인원은 미포함) · 사업보고서(분기)보다 빠른
                                    월 단위 관측
                                </div>
                            </div>
                        </>
            ...
            {realEstate && realEstate.total && (
                <>
                    ...
                    >
                        ...
                        {Array.isArray(realEstate.items) &&
                            realEstate.items.length > 0 && (
                                <div style={{ marginTop: 8 }}>
                                    {realEstate.items.map(
                                        (it: any, i: number) =>
                                            kvRow(
                                                it.name || "항목",
                                                it.value,
            ...
            {verityLens &&
                ...
                (() => {
                    ...
                    const lc =
                        ln.color === "success"
                            ? C.green
                            : ln.color === "warn" || ln.color === "caution"
                              ? C.amber
                              : ln.color === "danger"
                                ? C.down
                                : ln.color === "muted"
            ...
            >
                전 종목 사실 · 등급·추천 아님 · 출처
                DART·공정위·FnGuide·KRX·네이버 · 차트·시세 = TradingView
                위젯·네이버 · 점수 held(2027)
            </div>
        </div>
    )
...
addPropertyControls(PublicStockReport, {
    ...
    flowUrl: {
        type: ControlType.String,
        title: "Flow URL",
        defaultValue: DEFAULT_FLOW,
    },
    forensicsUrl: {
        type: ControlType.String,
        title: "Forensics URL",
        defaultValue: DEFAULT_FORENSICS,
    },
    insiderUrl: {
        type: ControlType.String,
        title: "Insider URL",
        defaultValue: DEFAULT_INSIDER,
    },
    warnUrl: {
        type: ControlType.String,
        title: "Warnings URL",
        defaultValue: DEFAULT_WARN,
    },
    lendingUrl: {
        type: ControlType.String,
        title: "Lending URL",
        defaultValue: DEFAULT_LENDING,
    },
    supplyUrl: {
        type: ControlType.String,
        title: "Supply/Demand URL",
