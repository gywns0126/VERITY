...
function clearSession() {
    ...
    try {
        window.sessionStorage.removeItem("verity_session_init")
    } catch (e) {}
}
    ...
    return (
        ...
        >
            ...
            >
                ...
                {!showLogout && (
                    <CaretRight size={15} color={sub} weight="bold" />
                )}
            </div>
            {showLogout && (
                <div
...
addPropertyControls(PublicMenuAccount, {
    variant: {
        ...
        title: "형태",
        options: ["account", "avatar"],
        optionTitles: ["계정 행", "아바타만"],
