...
function fetchPortfolioJson(url: string, signal?: AbortSignal): Promise<any> {
    ...
    return fetch(_cacheable ? url : _bustUrl(url), _cacheable ? { mode: "cors", credentials: "omit", signal, headers: _hdrs } : { cache: "no-store", mode: "cors", credentials: "omit", signal, headers: _hdrs })
