    ...
    return (
        <div style={{ position: "absolute" as const, top: 0, left: 0, right: 0, bottom: 0, background: BG, borderRadius: 12, padding: 14, zIndex: 10, overflow: "auto" as const }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                ...
                <button onClick={onClose} style={{ border: "none", background: "transparent", color: MUTED, borderRadius: 6, padding: "3px 9px", cursor: "pointer", fontSize: 12, fontFamily: font }}>닫기</button>
            </div>
...
const wrap: React.CSSProperties = { width: "100%", height: "100%", boxSizing: "border-box" as const, background: BG, borderRadius: 8, padding: 14, fontFamily: font, color: C.textPrimary, display: "flex", flexDirection: "column" as const, overflow: "hidden" }
