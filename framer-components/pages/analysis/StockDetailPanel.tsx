                            ...
                            <div style={{ width: "100%", minWidth: 0 }}>
                                ...
                                <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
                                    <button type="button" onClick={() => setOrderType("01")}
                                        style={{ border: "none", flex: 1, padding: "10px 0", borderRadius: 10, background: orderType === "01" ? "rgba(181,255,23,0.12)" : "transparent", color: orderType === "01" ? ACCENT : MUTED, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: _font }}>
                                        시장가
                                    </button>
                                    <button type="button" onClick={() => setOrderType("00")}
                                        style={{ border: "none", flex: 1, padding: "10px 0", borderRadius: 10, background: orderType === "00" ? "rgba(181,255,23,0.12)" : "transparent", color: orderType === "00" ? ACCENT : MUTED, fontSize: 13, fontWeight: 700, cursor: "pointer", fontFamily: _font }}>
                                        지정가
                                    </button>
                                </div>
